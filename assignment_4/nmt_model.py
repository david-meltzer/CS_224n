...
class NMT(nn.Module):
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]]:
        ...
        enc_hiddens, (last_hidden,last_cell) = self.encoder(pack_padded_sequence(X,source_lengths,enforce_sorted=True))
        ...
        ###         
        ###     Pad the packed sequence, enc_hiddens, returned by the encoder:https://pytorch.org/docs/stable/nn.html#torch.nn.utils.rnn.pack_padded_sequence
